        ...
        <button class="btn-bar"><i class="bars"> &#9776; </i></button>
            <nav>   
                ...
                <ul class="menu-header">
                    <li><a id="_home" class="" href="<?= BASE_URL ?>home"><i class="fas fa-tasks"></i>Activities</a> </li>
                    <li><a id="_folder" class="" href="<?= BASE_URL ?>folder"><i class="fas fa-folder"></i>Folders</a> </li>
                    <li><a id="_trash" class="" href="<?= BASE_URL ?>trash"> <i class="fas fa-recycle"></i>Paper bin</a></li>
                    ...
                    <div id="_perfil" class="perfil-cont-modal">
                        <div class="perfil-container-form">
                            ...
                            <a href="<?= BASE_URL ?>edit_profile"> <p class="perfil-txt"><i class="fas fa-user-edit"></i>Edit profile</p></a>
                            <a href="<?= BASE_URL ?>general/logout"> <p class="perfil-txt"><i class="fas fa-sign-in-alt"></i>Log out</p></a>
                        </div>
                    </div>
                </ul>
            </nav>
